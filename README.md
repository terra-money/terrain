...
```
USAGE
  $ terrain contract:build [CONTRACT] [--no-optimize] [--workspace <value>] [--arm64]
...
FLAGS
  ...
  --workspace=<value>  TODO: Add description here.

DESCRIPTION
  Build and optimize wasm bytecode.
```

_See code: [src/commands/contract/build.ts](https://github.com/terra-money/terrain/blob/v0.5.0-beta7/src/commands/contract/build.ts)_
...
```
USAGE
  $ terrain contract:optimize [CONTRACT] [--workspace <value>] [--arm64]
...
_See code: [src/commands/contract/optimize.ts](https://github.com/terra-money/terrain/blob/v0.5.0-beta7/src/commands/contract/optimize.ts)_
...
```
USAGE
  $ terrain deploy [CONTRACT] [--signer <value>] [--arm64] [--workspace <value>] [--no-rebuild]
    [--set-signer-as-admin] [--network <value>] [--config-path <value>] [--refs-path <value>] [--keys-path <value>]
    [--instance-id <value>] [--admin-address <value>] [--frontend-refs-path <value>]

...
export default class New extends Command {
  ...
  async run() {
    ...
    // Use npx degit instead of cargo generate for cloning cw-template -
    // as we already got node runtime available - less errors less dependencies.
    ...
    */
    ...
    execSync(`npx degit CosmWasm/cw-template#${flags.version} counter`)

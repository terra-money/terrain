...
const SCHEMADIR     = `/home/rxz/dev/ts-transofrms/${CONTRACT_NAME}/schema`    // json schema file generated by cosmwasm-schema
const NAMESPACE     = `/home/rxz/dev/ts-transofrms/typedefs/${CONTRACT_NAME}`  // typedefs will land here
